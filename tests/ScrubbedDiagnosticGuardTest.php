...
final class ScrubbedDiagnosticGuardTest extends GateTestCase
{
    ...
    private static function guardedFiles(): array
    {
        ...
        return [
            ...
            "{$root}/tests/CheckPhpatPresetTest.php",
            "{$root}/tests/Support/AbstractPhpatSubjectsTestCase.php",
            "{$root}/tests/CheckPhpatSubjectsTest.php",
            "{$root}/tests/CheckPhpatSubjectsTokenWalkTest.php",
            "{$root}/tests/CheckPhpatSubjectsReportTest.php",
            "{$root}/tests/CheckPhpatSubjectsDiscoveryTest.php",
